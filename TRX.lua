...
Toggle.MouseButton1Click:Connect(function()
    ...
    RunService.RenderStepped:Connect(function()
        if flying then
            ...
            Notify("سكربتات الدارك ", "تم تشغيل طياران السيارات", 3)
        end
    })

FaresTab:AddButton({
     Name=" سكربت طياران من صنع الدارك  FLY", 
     Callback=function()
     loadstring(game:HttpGet("https://raw.githubusercontent.com/ook314745-svg/fly/refs/heads/main/fly"))()
     
     Notify("سكربتات الدارك مع التعاون ", "تم تشغيل طيارنFLY", 3)
        end
    })


    FaresTab:AddButton({
        Name="شادر من صنع الدارك ",
        Callback=function()
...
RunService.RenderStepped:Connect(function()
    ...
    elseif selected == 3 then
        ...
        Lighting.OutdoorAmbient = Color3.fromRGB(255,140,80)
            ...
            Notify("سكربتات TRX مع الدارك", "تم تشغيل الشادر", 3)
        end
    })
    ...
    SkinTab:AddButton({Name="انسخ سكنات اقرب لاعب",Callback=function()
        local LChar=LocalPlayer.Character
